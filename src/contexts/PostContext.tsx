...
const INITIAL_POSTS: Post[] = [
    // --- VIDEO POSTS ---
    { id: 'v-1', title: 'Introduction to Web Development', authorId: 'mock', authorName: 'Sarah Johnson', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=400', rating: 4.8, views: 1520, duration: '12:34', uploadDate: new Date('2024-12-05'), status: 'approved' },
    { id: 'v-2', title: 'Creative Video Editing Tutorial', authorId: 'mock', authorName: 'Mike Chen', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1579109652910-99b9be06aaec?w=500', rating: 4.9, views: 2340, duration: '18:45', uploadDate: new Date('2024-12-04'), status: 'approved' },
    { id: 'v-3', title: 'Campus Life Vlog', authorId: 'mock', authorName: 'Emma Davis', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1492619375914-88005aa9e8fb?w=400', rating: 4.6, views: 890, duration: '8:20', uploadDate: new Date('2024-12-03'), status: 'approved' },
    { id: 'v-4', title: 'Tech Innovation Showcase', authorId: 'mock', authorName: 'Alex Rahman', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=400', rating: 4.7, views: 1680, duration: '15:12', uploadDate: new Date('2024-12-02'), status: 'approved' },
    { id: 'v-5', title: 'UI/UX Design Principles', authorId: 'mock', authorName: 'Rafiur Rahman', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400', rating: 4.9, views: 3200, duration: '22:15', uploadDate: new Date('2024-12-01'), status: 'approved' },
    { id: 'v-6', title: 'Mobile App Development Journey', authorId: 'mock', authorName: 'Lisa Park', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=400', rating: 4.7, views: 1850, duration: '16:40', uploadDate: new Date('2024-11-30'), status: 'approved' },
    { id: 'v-7', title: 'Photography Tips for Beginners', authorId: 'mock', authorName: 'David Lee', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=400', rating: 4.8, views: 2100, duration: '14:25', uploadDate: new Date('2024-11-29'), status: 'approved' },
    { id: 'v-8', title: 'Machine Learning Basics', authorId: 'mock', authorName: 'Jennifer Wu', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=400', rating: 4.6, views: 1450, duration: '20:30', uploadDate: new Date('2024-11-28'), status: 'approved' },
    { id: 'v-9', title: 'Animation Techniques', authorId: 'mock', authorName: 'Omar Hassan', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=400', rating: 4.9, views: 2890, duration: '19:15', uploadDate: new Date('2024-11-27'), status: 'approved' },
    { id: 'v-10', title: 'Game Development Tutorial', authorId: 'mock', authorName: 'Sophie Turner', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=400', rating: 4.8, views: 2650, duration: '25:10', uploadDate: new Date('2024-11-26'), status: 'approved' },
    { id: 'v-11', title: 'Digital Marketing Strategies', authorId: 'mock', authorName: 'Marcus Williams', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400', rating: 4.7, views: 2230, duration: '17:50', uploadDate: new Date('2024-11-25'), status: 'approved' },
    { id: 'v-12', title: 'Cybersecurity Essentials', authorId: 'mock', authorName: 'Nina Patel', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=400', rating: 4.9, views: 3100, duration: '21:30', uploadDate: new Date('2024-11-24'), status: 'approved' },
    { id: 'v-13', title: 'React.js Complete Guide', authorId: 'mock', authorName: 'Kevin Zhang', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=400', rating: 4.8, views: 2890, duration: '28:45', uploadDate: new Date('2024-11-23'), status: 'approved' },
    { id: 'v-14', title: 'Content Creation Tips', authorId: 'mock', authorName: 'Isabella Rodriguez', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=400', rating: 4.6, views: 1670, duration: '13:20', uploadDate: new Date('2024-11-22'), status: 'approved' },
    { id: 'v-15', title: 'Cloud Computing Overview', authorId: 'mock', authorName: 'Ahmed Khan', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400', rating: 4.7, views: 2050, duration: '19:40', uploadDate: new Date('2024-11-21'), status: 'approved' },
    { id: 'v-16', title: 'Data Visualization Techniques', authorId: 'mock', authorName: 'Emily Watson', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=400', rating: 4.9, views: 2780, duration: '16:15', uploadDate: new Date('2024-11-20'), status: 'approved' },
    { id: 'v-17', title: 'Blockchain Technology Explained', authorId: 'mock', authorName: 'Ryan Cooper', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=400', rating: 4.8, views: 2450, duration: '23:10', uploadDate: new Date('2024-11-19'), status: 'approved' },
    { id: 'v-18', title: '3D Modeling for Beginners', authorId: 'mock', authorName: 'Sophia Martinez', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1633356122102-3fe601e05bd2?w=400', rating: 4.7, views: 1920, duration: '24:30', uploadDate: new Date('2024-11-18'), status: 'approved' },
    { id: 'v-19', title: 'Public Speaking Masterclass', authorId: 'mock', authorName: 'Daniel Brown', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=400', rating: 4.9, views: 3350, duration: '18:55', uploadDate: new Date('2024-11-17'), status: 'approved' },
    { id: 'v-20', title: 'Product Design Process', authorId: 'mock', authorName: 'Olivia Johnson', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1586717791821-3f44a563fa4c?w=400', rating: 4.8, views: 2560, duration: '20:25', uploadDate: new Date('2024-11-16'), status: 'approved' },
    { id: 'v-21', title: 'SEO Best Practices 2024', authorId: 'mock', authorName: 'Michael Lee', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1709281847780-2b34c28853c0?w=400', rating: 4.7, views: 2190, duration: '15:40', uploadDate: new Date('2024-11-15'), status: 'approved' },
    { id: 'v-22', title: 'Python Programming Tutorial', authorId: 'mock', authorName: 'Rachel Green', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=400', rating: 4.9, views: 3420, duration: '26:50', uploadDate: new Date('2024-11-14'), status: 'approved' },
    { id: 'v-23', title: 'Entrepreneurship Journey', authorId: 'mock', authorName: 'James Wilson', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=400', rating: 4.8, views: 2710, duration: '22:35', uploadDate: new Date('2024-11-13'), status: 'approved' },
    { id: 'v-24', title: 'Documentary Filmmaking', authorId: 'mock', authorName: 'Laura Anderson', authorRole: 'creator', type: 'video', thumbnail: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?w=400', rating: 4.6, views: 1840, duration: '17:20', uploadDate: new Date('2024-11-12'), status: 'approved' },
